	...
	public String composeCoSignEnvelopeADRB21(Signature[] signb64)
		...
		try {
			...
			for(Signature nextSign : signb64){
				byte[] sign = b64dec.decodeBuffer(nextSign.getSignB64());
				byte[] origHash = b64dec.decodeBuffer(nextSign.getOrigHashB64());
				byte[] x509 = b64dec.decodeBuffer(nextSign.getX509B64());
				X509Certificate cert = loadCert(x509);
